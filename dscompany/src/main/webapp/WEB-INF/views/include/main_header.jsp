            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                         <img src="C://work//dscompany//src//main//webapp//resources//dist//img//profile${login.uimage}" class="user-image" alt="User Image">
                      <!-- <img src="http://localhost:8082/resources/dist/img/profile/default-user-image.jpg" class="user-image" alt="User Image"> -->
                        <span class="hidden-xs">${login.uname}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="user-header">
                            <img src="C://work//dscompany//src//main//webapp//resources//dist//img//profile${login.uimage}" class="img-circle" alt="User Image">
                            <p>
                                <small>
