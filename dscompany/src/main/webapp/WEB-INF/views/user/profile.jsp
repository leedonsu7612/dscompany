                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <img class="profile-user-img img-responsive img-circle"
                                 src="http://localhost:8082/resources/dist/img/profile${login.uimage}" alt="User profile picture">
                        ...
                        <form action="${path}/user/modify/image" id="userImageForm" method="post" enctype="multipart/form-data">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 210px;">
                                    <img src="http://localhost:8082/resources/dist/img/profile/${login.uimage}" >
                                </div>
