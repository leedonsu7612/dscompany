...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="${path}/user/loginPost" method="post">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox ">
                        <label>
                            <input type="checkbox" id="check1"  name="useCookie"> 로그인유지
                        </label>
                    </div>
                </div>
                <!-- /.col -->
        ...
        <div class="social-auth-links text-center">
           ...
           --> 
            <a href="https://www.naver.com/" class="btn btn-block btn-social btn-google btn-flat">
                <i class="fa fa-google-plus"></i> 네이버 계정으로 로그인
            </a> 
        </div>
        <!-- /.social-auth-links -->

        <a href="${path}/user/findpw">비밀번호 찾기</a><br>
...
<script>
 ...
 //   	$("input:checkbox[name='useCookie']:checked").length; 
